...
function showMatchingTracks() {
    const trackList = document.querySelector("#track-list");
    trackList.innerHTML = null;

    let matches = trackList.filter(doesTermMatch(tracks));

    matches.forEach((tracks) => {
        const snippet = dataToHTML(tracks);
